...
// Bloque colaborador: pendiente | marcado | confirmado | rechazado | cancelado
export type EstadoIndicacion = 'pendiente' | 'hecho' | 'marcado' | 'confirmado' | 'cancelado' | 'rechazado'
