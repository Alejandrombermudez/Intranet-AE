...
import {
  ...
  Image as ImageIcon, Users, Trees, MapPin, Activity, AlertCircle,
} from 'lucide-react'
...
const STEPS = [
  ...
  { label: 'Cámaras Trampa', icon: <Camera size={14} /> },
]
...
export default function NuevaFamiliaPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      const res = await fetchConSesion('/api/ras/familias', { method: 'POST', body: formData })
      if (res.ok) {
        router.push('/intranet/ras')
      } else {
  ...
  return (
    <div className="min-h-screen bg-papel">
      ...
      <Cabecera
        ...
        titulo="Nueva familia en restauración"
      />
          ...
          {step === 0 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  <Label required>Nombre del propietario</Label>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="number" min={0} step="0.01" {...register('ha_restauracion')} className={errors.ha_restauracion ? inputErrCls : inputCls} />
            ...
            <div className="space-y-5">
              ...
              {monitoreoFields.length === 0 && (
                <div className="flex flex-col items-center justify-center py-12 text-stone-400 gap-3 border-2 border-dashed border-stone-200 rounded-2xl">
                  ...
                  <p className="text-xs">Usa el botón <strong>Agregar</strong> para añadir eventos de monitoreo.</p>
                </div>
              )}
                            ...
                            {(fotosPorCamara[i] ?? []).map((f, fi) => {
                              ...
                              return (
                                <div key={fi} className="relative group">
                                  ...
                                  <button type="button"
                                    onClick={() => setFotosPorCamara((prev) => ({
                                      ...prev,
