...
/**
 * DELETE /api/ras/conservacion/fotos/[photoId]
 * Elimina una foto de predio: borra la fila de ras.fotos_predio
 * Y el archivo del bucket ras-fotos-predio.
 */
export async function DELETE(
  ...
  try {
    ...
    const { error: deleteErr } = await supabase
      .schema('ras').from('fotos_predio').delete().eq('id', photoId)
    ...
    console.error('Error DELETE /api/ras/conservacion/fotos/[photoId]:', err)
