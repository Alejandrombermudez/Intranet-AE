...
/**
 * DELETE /api/ras/familias/[id]
 * Elimina una familia y todos sus registros relacionados (CASCADE en BD).
...
export async function DELETE(
  ...
  try {
    ...
    // ── Auth: extraer email del header o cookie de sesión ──
    ...
    // ── Eliminar familia (CASCADE borra monitoreos, camaras_trampa, fotos_camara) ──
